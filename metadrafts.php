...
* Description: Metadrafts creates a curated workflow for the revision of both new and published posts, including revision of postmeta
* Version: 1.0.0
...
function md_on_save_request_review($post_id){
	...
	if(isset($_POST['md_request_review']) && md_is_metadraft($post_id)){
		...
		||  $metadraft->md_status == 'md-draft')){
			...
			md_notify('review-request', $post_id, $user_id, $comment_content);
